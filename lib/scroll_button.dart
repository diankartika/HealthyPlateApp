...
class _ScrollableButtonGridState extends State<ScrollableButtonGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    List<List<Map<String, dynamic>>> columns = List.generate(totalColumns, (columnIndex) {
        ...
        children: columns.map((column) {
          return Padding(
            ...
            child: Column(
              ...
              children: column.map((data) {
                final bool isSelected = selectedButtons.contains(data['id']);
                return Padding(
